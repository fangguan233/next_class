...
## v1.3.5 更新日志 (2026-03-25)

本次更新引入了ai助手来修改课程表，现在只需要一句话就可以调整课程表了。

## v1.3.4 更新日志 (2025-10-02)

本次更新引入了全新的**甘特图可视化编辑**功能，并对冲突检测进行了全面升级，旨在提供更直观、更强大的课程表编辑体验。

### ✨ 新功能 & 优化

1.  **甘特图可视化编辑**:
    *   **功能**: 新增了甘特图视图，用户可以通过拖拽课程块的方式，直观地调整课程的时间和星期。
    *   **实时反馈**: 拖拽过程中，系统会实时高亮显示目标位置，并进行全局冲突检测
